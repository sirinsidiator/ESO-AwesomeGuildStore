AwesomeGuildStore.Localization = {
    ...
    FILTER_CATEGORY_FURNISHING = GetString("SI_ITEMFILTERTYPE", ITEMFILTERTYPE_FURNISHING),
    ...
    FILTER_SUBCATEGORY_MASTER_WRIT = zo_strformat(SI_TOOLTIP_ITEM_NAME, GetString("SI_ITEMTYPE", ITEMTYPE_MASTER_WRIT)),
    ...
    FILTER_SUBCATEGORY_FURNISHING_CRAFTING_STATION = zo_strformat(SI_TOOLTIP_ITEM_NAME, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_CRAFTING_STATION)),
    FILTER_SUBCATEGORY_FURNISHING_LIGHT = zo_strformat(SI_TOOLTIP_ITEM_NAME, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_LIGHT)),
    FILTER_SUBCATEGORY_FURNISHING_ORNAMENTAL = zo_strformat(SI_TOOLTIP_ITEM_NAME, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_ORNAMENTAL)),
    FILTER_SUBCATEGORY_FURNISHING_SEATING = zo_strformat(SI_TOOLTIP_ITEM_NAME, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_SEATING)),
    FILTER_SUBCATEGORY_FURNISHING_TARGET_DUMMY = zo_strformat(SI_TOOLTIP_ITEM_NAME, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_TARGET_DUMMY)),
    ...
    SUBFILTER_INGREDIENT_TYPE_ANIMAL_PART = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_REAGENT_ANIMAL_PART)),
    SUBFILTER_INGREDIENT_TYPE_FUNGUS = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_REAGENT_FUNGUS)),
    SUBFILTER_INGREDIENT_TYPE_HERB = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_REAGENT_HERB)),
    ...
    SUBFILTER_RECIPE_TYPE_LABEL = "Recipe Type",
    SUBFILTER_RECIPE_TYPE_FOOD = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_FOOD)),
    SUBFILTER_RECIPE_TYPE_DRINK = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_DRINK)),
    SUBFILTER_RECIPE_TYPE_BLACKSMITHING = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_BLACKSMITHING_DIAGRAM_FURNISHING)),
    SUBFILTER_RECIPE_TYPE_CLOTHIER = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING)),
    SUBFILTER_RECIPE_TYPE_WOODWORKING = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_WOODWORKING_BLUEPRINT_FURNISHING)),
    SUBFILTER_RECIPE_TYPE_ALCHEMY = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_ALCHEMY_FORMULA_FURNISHING)),
    SUBFILTER_RECIPE_TYPE_ENCHANTING = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_ENCHANTING_SCHEMATIC_FURNISHING)),
    SUBFILTER_RECIPE_TYPE_PROVISIONING = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_DESIGN_FURNISHING)),

    SUBFILTER_DRINK_TYPE_LABEL = "Drink Type",
    SUBFILTER_DRINK_TYPE_ALCOHOLIC = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_ALCOHOLIC)),
    SUBFILTER_DRINK_TYPE_CORDIAL_TEA = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_CORDIAL_TEA)),
    SUBFILTER_DRINK_TYPE_DISTILLATE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_DISTILLATE)),
    SUBFILTER_DRINK_TYPE_LIQUER = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_LIQUEUR)),
    SUBFILTER_DRINK_TYPE_TEA = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_TEA)),
    SUBFILTER_DRINK_TYPE_TINCTURE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_TINCTURE)),
    SUBFILTER_DRINK_TYPE_TONIC = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_TONIC)),
    SUBFILTER_DRINK_TYPE_UNIQUE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_DRINK_UNIQUE)),

    SUBFILTER_FOOD_TYPE_LABEL = "Food Type",
    SUBFILTER_FOOD_TYPE_ENTREMET = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_ENTREMET)),
    SUBFILTER_FOOD_TYPE_FRUIT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_FRUIT)),
    SUBFILTER_FOOD_TYPE_GOURMET = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_GOURMET)),
    SUBFILTER_FOOD_TYPE_MEAT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_MEAT)),
    SUBFILTER_FOOD_TYPE_RAGOUT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_RAGOUT)),
    SUBFILTER_FOOD_TYPE_SAVOURY = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_SAVOURY)),
    SUBFILTER_FOOD_TYPE_VEGETABLE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_VEGETABLE)),
    SUBFILTER_FOOD_TYPE_UNIQUE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FOOD_UNIQUE)),

    SUBFILTER_INGREDIENT_TYPE_ALCOHOL = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_ALCOHOL)),
    SUBFILTER_INGREDIENT_TYPE_DRINK_ADDITIVE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_DRINK_ADDITIVE)),
    SUBFILTER_INGREDIENT_TYPE_FOOD_ADDITIVE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_FOOD_ADDITIVE)),
    SUBFILTER_INGREDIENT_TYPE_FRUIT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_FRUIT)),
    SUBFILTER_INGREDIENT_TYPE_MEAT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_MEAT)),
    SUBFILTER_INGREDIENT_TYPE_RARE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_RARE)),
    SUBFILTER_INGREDIENT_TYPE_TEA = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_TEA)),
    SUBFILTER_INGREDIENT_TYPE_TONIC = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_TONIC)),
    SUBFILTER_INGREDIENT_TYPE_VEGETABLE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_INGREDIENT_VEGETABLE)),

    SUBFILTER_SIEGE_TYPE_LABEL = "Siege Type",
    SUBFILTER_SIEGE_TYPE_BALLISTA = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_BALLISTA)),
    SUBFILTER_SIEGE_TYPE_CATAPULT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_CATAPULT)),
    SUBFILTER_SIEGE_TYPE_TREBUCHET = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_TREBUCHET)),
    SUBFILTER_SIEGE_TYPE_OIL = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_OIL)),
    SUBFILTER_SIEGE_TYPE_RAM = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_RAM)),
    SUBFILTER_SIEGE_TYPE_GRAVEYARD = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_GRAVEYARD)),
    SUBFILTER_SIEGE_TYPE_UNIVERSAL = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_SIEGE_UNIVERSAL)),

    SUBFILTER_TROPHY_TYPE_LABEL = "Trophy Type",
    SUBFILTER_TROPHY_TYPE_KEY = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_KEY)),
    SUBFILTER_TROPHY_TYPE_KEY_FRAGMENT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_KEY_FRAGMENT)),
    SUBFILTER_TROPHY_TYPE_MATERIAL_UPGRADER = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_MATERIAL_UPGRADER)),
    SUBFILTER_TROPHY_TYPE_MUSEUM_PIECE = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_MUSEUM_PIECE)),
    SUBFILTER_TROPHY_TYPE_RECIPE_FRAGMENT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_RECIPE_FRAGMENT)),
    SUBFILTER_TROPHY_TYPE_SCROLL = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_SCROLL)),
    SUBFILTER_TROPHY_TYPE_SURVEY_REPORT = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_SURVEY_REPORT)),
    SUBFILTER_TROPHY_TYPE_TREASURE_MAP = zo_strformat("<<1>>", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_TROPHY_TREASURE_MAP)),
