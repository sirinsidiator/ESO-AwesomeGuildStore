local localization = {
	...
	ru = {
		...
		SETTINGS_REPLACE_CATEGORY_FILTER_LABEL = "Ècïoìöçoáaòö óäoàîÿe êaòeâopèè oòàopa",
		SETTINGS_REPLACE_CATEGORY_FILTER_DESCRIPTION = "Çaíeîüeò còaîäapòîÿé áÿàop íîoæecòáo êîoïoê",
		SETTINGS_REPLACE_PRICE_FILTER_LABEL = "Ècïoìöçoáaòö óäoàîÿé ïoìçóîoê œeî",
		SETTINGS_REPLACE_PRICE_FILTER_DESCRIPTION = "Äoàaáìüeò óäoàîÿé ïoìçóîoê äìü oòàopa ïo œeîaí",
		SETTINGS_REPLACE_LEVEL_FILTER_LABEL = "Ècïoìöçoáaòö óäoàîÿé ïoìçóîoê ópoáîeé",
		SETTINGS_REPLACE_LEVEL_FILTER_DESCRIPTION = "Äoàaáìüeò óäoàîÿé ïoìçóîoê äìü oòàopa ïo ópoáîüí",
		SETTINGS_REPLACE_QUALITY_FILTER_LABEL = "Ècïoìöçoáaòö óäoàîÿé áÿàop êaùecòáa",
		SETTINGS_REPLACE_QUALITY_FILTER_DESCRIPTION = "Çaíeîüeò còaîäapòîÿé áÿàop îa áÿàop ïo äèaïaçoîó",
