local localization = {
	en = {
		...
		SUBFILTER_ITEM_STYLE_BRETON = GetString(SI_ITEMSTYLE1),
		SUBFILTER_ITEM_STYLE_REDGUARD = GetString(SI_ITEMSTYLE2),
		SUBFILTER_ITEM_STYLE_ORC = GetString(SI_ITEMSTYLE3),
		SUBFILTER_ITEM_STYLE_DUNMER = GetString(SI_ITEMSTYLE4),
		SUBFILTER_ITEM_STYLE_NORD = GetString(SI_ITEMSTYLE5),
		SUBFILTER_ITEM_STYLE_ARGONIAN = GetString(SI_ITEMSTYLE6),
		SUBFILTER_ITEM_STYLE_ALTMER = GetString(SI_ITEMSTYLE7),
		SUBFILTER_ITEM_STYLE_BOSMER = GetString(SI_ITEMSTYLE8),
		SUBFILTER_ITEM_STYLE_KHAJIIT = GetString(SI_ITEMSTYLE9),
		SUBFILTER_ITEM_STYLE_IMPERIAL = GetString(SI_ITEMSTYLE16),
		SUBFILTER_ITEM_STYLE_ANCIENT_ELF = GetString(SI_ITEMSTYLE15),
		SUBFILTER_ITEM_STYLE_PRIMAL = GetString(SI_ITEMSTYLE19),
		SUBFILTER_ITEM_STYLE_BARBARIC = GetString(SI_ITEMSTYLE17),
		SUBFILTER_ITEM_STYLE_DAEDRIC = GetString(SI_ITEMSTYLE20),
		SUBFILTER_ITEM_STYLE_DWEMER = GetString(SI_ITEMSTYLE14),
		SUBFILTER_ITEM_STYLE_GLASS = GetString(SI_ITEMSTYLE28),
		SUBFILTER_ITEM_STYLE_XIVKYN = GetString(SI_ITEMSTYLE29),
		SUBFILTER_ITEM_STYLE_DAGGERFALL = GetString(SI_ITEMSTYLE23),
		SUBFILTER_ITEM_STYLE_EBONHEART = GetString(SI_ITEMSTYLE24),
		SUBFILTER_ITEM_STYLE_ALDMERI = GetString(SI_ITEMSTYLE25),
		SUBFILTER_ITEM_STYLE_OTHER = GetString(SI_TRADING_HOUSE_BROWSE_ITEM_TYPE_OTHER),

		SUBFILTER_ITEM_SET_LABEL = "Itemset", -- TODO
		SUBFILTER_ITEM_SET_NORMAL = "Not part of a set", -- TODO
		SUBFILTER_ITEM_SET_HAS_SET = "Part of a set", -- TODO
