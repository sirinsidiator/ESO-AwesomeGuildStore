local localization = {
	en = {
		...
		SUBFILTER_ITEM_STYLE_BRETON = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_BRETON),
		SUBFILTER_ITEM_STYLE_REDGUARD = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_REDGUARD),
		SUBFILTER_ITEM_STYLE_ORC = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_ORC),
		SUBFILTER_ITEM_STYLE_DUNMER = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_DARK_ELF),
		SUBFILTER_ITEM_STYLE_NORD = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_NORD),
		SUBFILTER_ITEM_STYLE_ARGONIAN = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_ARGONIAN),
		SUBFILTER_ITEM_STYLE_ALTMER = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_HIGH_ELF),
		SUBFILTER_ITEM_STYLE_BOSMER = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_WOOD_ELF),
		SUBFILTER_ITEM_STYLE_KHAJIIT = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_KHAJIIT),
		SUBFILTER_ITEM_STYLE_IMPERIAL = GetString("SI_ITEMSTYLE", ITEMSTYLE_RACIAL_IMPERIAL),
		SUBFILTER_ITEM_STYLE_ANCIENT_ELF = GetString("SI_ITEMSTYLE", ITEMSTYLE_AREA_ANCIENT_ELF),
		SUBFILTER_ITEM_STYLE_PRIMAL = GetString("SI_ITEMSTYLE", ITEMSTYLE_ENEMY_PRIMITIVE),
		SUBFILTER_ITEM_STYLE_BARBARIC = GetString("SI_ITEMSTYLE", ITEMSTYLE_AREA_REACH),
		SUBFILTER_ITEM_STYLE_DAEDRIC = GetString("SI_ITEMSTYLE", ITEMSTYLE_ENEMY_DAEDRIC),
		SUBFILTER_ITEM_STYLE_DWEMER = GetString("SI_ITEMSTYLE", ITEMSTYLE_AREA_DWEMER),
		SUBFILTER_ITEM_STYLE_GLASS = GetString("SI_ITEMSTYLE", ITEMSTYLE_GLASS),
		SUBFILTER_ITEM_STYLE_XIVKYN = GetString("SI_ITEMSTYLE", ITEMSTYLE_AREA_XIVKYN),
		SUBFILTER_ITEM_STYLE_DAGGERFALL = GetString("SI_ITEMSTYLE", ITEMSTYLE_ALLIANCE_DAGGERFALL),
		SUBFILTER_ITEM_STYLE_EBONHEART = GetString("SI_ITEMSTYLE", ITEMSTYLE_ALLIANCE_EBONHEART),
		SUBFILTER_ITEM_STYLE_ALDMERI = GetString("SI_ITEMSTYLE", ITEMSTYLE_ALLIANCE_ALDMERI),
		SUBFILTER_ITEM_STYLE_AKAVIRI = GetString("SI_ITEMSTYLE", ITEMSTYLE_AREA_AKAVIRI),
		SUBFILTER_ITEM_STYLE_MERCENARY = GetString("SI_ITEMSTYLE", ITEMSTYLE_UNDAUNTED),
		SUBFILTER_ITEM_STYLE_ANCIENT_ORC = GetString("SI_ITEMSTYLE", ITEMSTYLE_AREA_ANCIENT_ORC),
		SUBFILTER_ITEM_STYLE_MALACATH = GetString("SI_ITEMSTYLE", ITEMSTYLE_DEITY_MALACATH),
		SUBFILTER_ITEM_STYLE_TRINIMAC = GetString("SI_ITEMSTYLE", ITEMSTYLE_DEITY_TRINIMAC),
		SUBFILTER_ITEM_STYLE_SOUL_SHRIVEN = GetString("SI_ITEMSTYLE", ITEMSTYLE_AREA_SOUL_SHRIVEN),
		SUBFILTER_ITEM_STYLE_OUTLAW = GetString("SI_ITEMSTYLE", ITEMSTYLE_UNUSED9),
