...
AwesomeGuildStore.data.BLACKSMITHING_MATERIAL_TYPE_FILTER = BLACKSMITHING_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.CLOTHING_MATERIAL_TYPE_FILTER = CLOTHING_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.WOODWORKING_MATERIAL_TYPE_FILTER = WOODWORKING_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.STYLE_MATERIAL_TYPE_FILTER = STYLE_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.ALCHEMY_MATERIAL_TYPE_FILTER = ALCHEMY_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.ENCHANTING_MATERIAL_TYPE_FILTER = ENCHANTING_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.PROVISIONING_MATERIAL_TYPE_FILTER = PROVISIONING_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.FURNISHING_MATERIAL_TYPE_FILTER = FURNISHING_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.TRAIT_MATERIAL_TYPE_FILTER = TRAIT_MATERIAL_TYPE_FILTER
AwesomeGuildStore.data.JEWELRY_MATERIAL_TYPE_FILTER = JEWELRY_MATERIAL_TYPE_FILTER
