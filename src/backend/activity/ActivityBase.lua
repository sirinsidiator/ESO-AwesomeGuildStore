...
ActivityBase.ACTIVITY_TYPE_PREVIEW_ITEM = 8
...
ActivityBase.RESULT_PREVIEW_ITEM_ON_CURRENT_PAGE = -102
ActivityBase.RESULT_PREVIEW_ITEM_NO_LONGER_AVAILABLE = -103
ActivityBase.RESULT_PREVIEW_ITEM_NAME_MATCH_FAILED = -104
...
local RESPONSE_TYPE_BY_ACTIVITY_TYPE = { -- TODO: should be part of each activity
    ...
    [ActivityBase.ACTIVITY_TYPE_PREVIEW_ITEM] = TRADING_HOUSE_RESULT_SEARCH_PENDING,
}
...
local RESULT_TO_STRING = {
    ...
    [ActivityBase.RESULT_PREVIEW_ITEM_ON_CURRENT_PAGE] = "RESULT_PREVIEW_ITEM_ON_CURRENT_PAGE",
    [ActivityBase.RESULT_PREVIEW_ITEM_NO_LONGER_AVAILABLE] = "RESULT_PREVIEW_ITEM_NO_LONGER_AVAILABLE",
    [ActivityBase.RESULT_PREVIEW_ITEM_NAME_MATCH_FAILED] = "RESULT_PREVIEW_ITEM_NAME_MATCH_FAILED",
}
