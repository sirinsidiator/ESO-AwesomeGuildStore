...
local integrityCheckList = {
    ...
    ["frontend/ActivityPanel.xml"] = function() return AwesomeGuildStoreActivityWindow ~= nil end,
    ["frontend/ActivityPanel.lua"] = function() return AGS.class.ActivityPanel ~= nil end,
    ...
    ["wrappers/ActivityLogWrapper.lua"] = function() return AGS.class.ActivityLogWrapper ~= nil end,
